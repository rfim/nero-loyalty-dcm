...
--
--   NERO_LOAD_WH  ingestion (PROCESS_BATCH / CONTRACT_GATE_TASK)  bursty, short
...
CREATE WAREHOUSE IF NOT EXISTS NERO_LOAD_WH
  ...
  COMMENT = 'Ingestion compute: PROCESS_BATCH/RUN_PENDING via CONTRACT_GATE_TASK and manual batch loads. Bursty, short-lived — fast auto-suspend.';
