...
CREATE ROLE IF NOT EXISTS NERO_INGEST_ROLE
  COMMENT = 'Ingestion service role: PROCESS_BATCH/RUN_PENDING execution and LANDING_STAGE writes only. No direct table access beyond SELECT/INSERT on the typed BRONZE_<DATASET>/BRONZE_BATCH_MANIFESTS tables.';
