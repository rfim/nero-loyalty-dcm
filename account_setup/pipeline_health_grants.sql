...
-- NERO_DB: batch publish audit trail + release pointer + raw/validated counts
...
GRANT USAGE ON SCHEMA NERO_DB."02_CONTROL" TO ROLE NERO_GOVERNANCE_ROLE;

GRANT SELECT ON TABLE NERO_DB."00_BRONZE".RAW_ENVELOPES TO ROLE NERO_GOVERNANCE_ROLE;
...
GRANT SELECT ON TABLE NERO_DB."02_CONTROL".CONTROL_RUN_AUDIT TO ROLE NERO_GOVERNANCE_ROLE;
GRANT SELECT ON TABLE NERO_DB."02_CONTROL".CONTROL_RELEASE_POINTER TO ROLE NERO_GOVERNANCE_ROLE;
