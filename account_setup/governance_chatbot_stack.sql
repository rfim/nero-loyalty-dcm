...
CREATE OR REPLACE SEMANTIC VIEW NERO_GOVERNANCE.APPS.GOVERNANCE_SEMANTIC_VIEW
  TABLES (
...
GRANT USAGE ON SCHEMA NERO_GOVERNANCE.APPS TO ROLE NERO_GOVERNANCE_ROLE;
...
GRANT REFERENCES ON SEMANTIC VIEW NERO_GOVERNANCE.APPS.GOVERNANCE_SEMANTIC_VIEW TO ROLE NERO_GOVERNANCE_ROLE;
GRANT USAGE ON CORTEX SEARCH SERVICE NERO_GOVERNANCE.SECURITY.FINDINGS_SEARCH_SVC TO ROLE NERO_GOVERNANCE_ROLE;
GRANT CREATE STREAMLIT ON SCHEMA NERO_GOVERNANCE.APPS TO ROLE NERO_GOVERNANCE_ROLE;
GRANT USAGE ON INTEGRATION NERO_PYPI_ACCESS_INTEGRATION TO ROLE NERO_GOVERNANCE_ROLE;
GRANT SELECT, INSERT, UPDATE ON TABLE NERO_GOVERNANCE.APPS.CHAT_CONVERSATIONS TO ROLE NERO_GOVERNANCE_ROLE;
GRANT SELECT, INSERT ON TABLE NERO_GOVERNANCE.APPS.CHAT_MESSAGES TO ROLE NERO_GOVERNANCE_ROLE;
