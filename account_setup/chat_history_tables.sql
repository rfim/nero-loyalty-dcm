...
CREATE TABLE IF NOT EXISTS NERO_GOVERNANCE.APPS_CHATBOTS.CHAT_CONVERSATIONS (
...
CREATE TABLE IF NOT EXISTS NERO_GOVERNANCE.APPS_CHATBOTS.CHAT_MESSAGES (
...
GRANT SELECT, INSERT, UPDATE ON TABLE NERO_GOVERNANCE.APPS_CHATBOTS.CHAT_CONVERSATIONS TO ROLE NERO_BI_ROLE;
GRANT SELECT, INSERT ON TABLE NERO_GOVERNANCE.APPS_CHATBOTS.CHAT_MESSAGES TO ROLE NERO_BI_ROLE;
...
GRANT USAGE ON SCHEMA NERO_GOVERNANCE.CORTEX_TOOLS TO ROLE NERO_BI_ROLE;
