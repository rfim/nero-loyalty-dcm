...
-- COST_REPORTS/SECURITY_GOVERNANCE_REPORT/PIPELINE_HEALTH are retired --
-- replaced by PLATFORM_GOVERNANCE (one app, five tabs). This file's own
-- warning below ("any new app needs its own GRANT... line added here")
-- is exactly what got missed when that consolidation shipped -- the new
-- object existed with no ACCOUNTADMIN USAGE grant at all.
GRANT USAGE ON STREAMLIT NERO_GOVERNANCE.APPS_DASHBOARDS.PLATFORM_GOVERNANCE TO ROLE ACCOUNTADMIN;
GRANT USAGE ON STREAMLIT NERO_GOVERNANCE.APPS_DASHBOARDS.LOYALTY_ENGAGEMENT_SALES TO ROLE ACCOUNTADMIN;

-- CHATBOT_SECURITY_GOVERNANCE_REPORT is retired -- folded into
-- PLATFORM_GOVERNANCE's Chatbot Security tab.
