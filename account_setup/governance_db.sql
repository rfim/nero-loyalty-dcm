...
CREATE OR REPLACE VIEW SECURITY.LOGIN_ACTIVITY_DAILY AS
SELECT
    DATE_TRUNC('day', EVENT_TIMESTAMP) AS LOGIN_DATE,
...
COMMENT ON VIEW SECURITY.LOGIN_ACTIVITY_DAILY IS
  'Successful vs. failed login counts by day, last 30 days — the daily trend behind FAILED_LOGINS_DAILY.';
