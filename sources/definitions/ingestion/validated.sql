...
DEFINE TABLE NERO_DB."01_SILVER".VALIDATED_LOYALTY_CUSTOMERS (
...
SELECT
    ...
    (SELECT COUNT(*) FROM NERO_DB."01_SILVER".VALIDATED_LOYALTY_CUSTOMERS) AS LOYALTY_CUSTOMERS_COUNT,
    (SELECT COUNT(*) FROM NERO_DB."01_SILVER".VALIDATED_LOYALTY_EVENTS) AS LOYALTY_EVENTS_COUNT,
    (SELECT COUNT(*) FROM NERO_DB."01_SILVER".VALIDATED_STORES) AS STORES_COUNT,
    (SELECT COUNT(*) FROM NERO_DB."01_SILVER".VALIDATED_TRANSACTIONS) AS TRANSACTIONS_COUNT
FROM NERO_DB."02_CONTROL".CONTROL_RELEASE_POINTER p
