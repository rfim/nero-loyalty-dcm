...
CREATE STAGE IF NOT EXISTS NERO_DB.NERO_LOYALTY.S3_STAGE
    URL = 's3://REPLACE_BUCKET/nero/'
    STORAGE_INTEGRATION = NERO_S3_INTEGRATION
    FILE_FORMAT = NERO_DB.NERO_LOYALTY.JSON_LINES;

CREATE PIPE IF NOT EXISTS NERO_DB.NERO_LOYALTY.CONTRACT_PIPE
    AUTO_INGEST = TRUE
AS
COPY INTO NERO_DB.NERO_LOYALTY.RAW_ENVELOPES
...
FROM (
    ...
    FROM @NERO_DB.NERO_LOYALTY.S3_STAGE
)
