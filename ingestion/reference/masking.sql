...
-- ---- attach to columns in 01_BRONZE (manual, after the policies above are deployed) ----

ALTER TABLE NERO_DB."01_BRONZE".BRONZE_LOYALTY_CUSTOMERS MODIFY COLUMN CUSTOMER_ID SET MASKING POLICY NERO_DB."05_PII_CONTROL".MASK_IDENTIFIER_INTEGER;
ALTER TABLE NERO_DB."01_BRONZE".BRONZE_LOYALTY_EVENTS MODIFY COLUMN CUSTOMER_ID SET MASKING POLICY NERO_DB."05_PII_CONTROL".MASK_IDENTIFIER_INTEGER;
ALTER TABLE NERO_DB."01_BRONZE".BRONZE_TRANSACTIONS MODIFY COLUMN CUSTOMER_ID SET MASKING POLICY NERO_DB."05_PII_CONTROL".MASK_IDENTIFIER_INTEGER;
